# Auto-generated from simscript_hystpwm_asc.m
...
function [ShaftPosition, CircuitControl, Settings, Enforce, Userdata] = ...
          simscript_hystpwm_asc(Outputs,Settings,Userdata,Circuit,Drive,Geometry,Mesh,Windings,A,cell_p,cell_t,cell_Nu,path)
