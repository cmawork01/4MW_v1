# Auto-generated from simscript_hystpwm_eccentric.m
...
function [ShaftPosition, CircuitControl, Settings, Enforce, Userdata] = ...
          simscript_hystpwm_eccentric(Outputs,Settings,Userdata,Circuit,Drive,Geometry,Mesh,Windings,A,cell_p,cell_t,cell_Nu,path)
% Simulation script file to be used with function InvertedCircuit.m
% Current hysteresis PWM, rotor with static eccentricity 1%
...
lag=Geometry.lag/1000;    % airgap length
ShaftPosition=[0.01*lag 0];
