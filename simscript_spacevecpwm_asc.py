# Auto-generated from simscript_spacevecpwm_asc.m
...
function [ShaftPosition, CircuitControl, Settings, Enforce, Userdata] = ...
          simscript_spacevecpwm_asc(Outputs,Settings,Userdata,Circuit,Drive,Geometry,Mesh,Windings,A,cell_p,cell_t,cell_Nu,path)
% Simulation script file to be used with function InvertedCircuit.m
% Active short circuit simulation (three phase space vector pulse width modulation)
...
if CurrentTime>ASCtime    
    ...
    CircuitControl.switch_c1=1;
    CircuitControl.switch_c2=0;  
%     Enforce=[];      % uncomment to simulate with variable speed
end
